...
public class ServerConfig {
    ...
    public static final String ERROR_FILE_NOT_FOUND = "ERROR|Plik nie znaleziony";
    public static final String ERROR_UPLOAD_FAILED = "ERROR|Wysłanie pliku nie powiodłoło się";
